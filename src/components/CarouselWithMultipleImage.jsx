...
const ImageCarousel1 = ({ images }) => {
  return (
    <Paper sx={{height:'270px'}}>
        {/* {console.log(images,"-098767890-09876789878998")} */}
        {images === [] && <Carousel showArrows={false} dynamicHeight={false}>
        {images.map((image, index) => (<>
            {/* {console.log("bbbbvvbb-",image)} */}
          <Box key={index}>
            <img
              src={image}
              alt="no image"
...
//   console.log("imageSetsimageSetsimageSets098", imageSets);
